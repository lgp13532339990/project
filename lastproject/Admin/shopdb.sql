...
--
-- Host: localhost
-- Generation Time: 2017-04-06 05:18:38
-- 服务器版本： 5.7.17
-- PHP Version: 7.1.3
...
CREATE TABLE `b_book` (
  ...
  `book_status` char(5) NOT NULL DEFAULT 'true',
...
(21, '睡不着', 'Tango 著', 24, 1488437064, 'true', '<p></p><p>\r\n	　　除了音乐和文字，还有什么能让你感到轻松喜悦，嘴角上扬的？<br/>　　新浪微博红人TANGO三年来夜夜一幅幽默画，陪伴无数睡不着的人度过无眠之夜。源源不断的创意和坚持，让人在看懂之后会心一笑，成为粉丝每晚必看的治愈源泉。<br/>　　轻松、温暖、无厘头的奇思妙想，帮你重新发现藏在每个角落的欢乐。<br/>　　其实，活着可以是一件很有趣的事情。</p>', 3),
...
(23, '你要么出众，要么出局', '李尚龙', 28.7, 1488437386, 'true', '<p><br/>　　本书是百万畅销书作家、中国优质新偶像李尚龙写给千万年轻人的成长激励之书。 <br/>　　全书41篇作者亲历、亲闻的故事，如同41个特写镜头，把生活的现实、功利、残酷拆开来给你看，为你提供全新的观察生活和审视自己的视角，告诉你年轻时没有安稳平淡的中间选项，你要么大汗淋漓地出众，活出耀眼且丰盛的自己，要么小心翼翼地出局，被迫面对人生的遗憾和后悔。 <br/>　　多篇火爆朋友圈的正能量好文《舒适区终有一天会毁掉青春》《寂寞是*好的增值期》《忙起来多好，因为闲下来更累》《下班后的生活，决定了人的一生》《弱者看平台，强者造平台》《别怕麻烦人，好的朋友都是麻烦出来的》等也都收录在本书当中。 <br/><br/>　　精选语录： <br/><br/>　　时光，不会辜负每一个平静努力的人。</p>', 3),
(34, 'asd', 'asd', 123, 1491447681, 'true', '<p>黄瓜富含钙</p>', 3);
...
(21, '19.jpg', 19),
(22, '20.jpg', 20),
(23, '/Public/Uploads/bookImage/book_id_21/21_1491384469_1984585054.jpg', 21),
(24, '/Public/Uploads/bookImage/book_id_23/23_1491379407_632890803.jpg', 23),
(25, '22.jpg', 22);
