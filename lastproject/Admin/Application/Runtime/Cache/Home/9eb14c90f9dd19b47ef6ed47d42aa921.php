...
<body>
    ...
    <ul class="nav">
        ...
        <!-- <li>
                        <a href="messages.html" title=""><img src="/PHP_2/Admin/Public/TPLDIST/images/icons/mainnav/messages.png" alt="" /><span>Messages</span></a>
                    </li>
                    <li>
                        <a href="statistics.html" title=""><img src="/PHP_2/Admin/Public/TPLDIST/images/icons/mainnav/statistics.png" alt="" /><span>Statistics</span></a>
                    </li>
                    <li>
                        <a href="tables.html" title=""><img src="/PHP_2/Admin/Public/TPLDIST/images/icons/mainnav/tables.png" alt="" /><span>Tables</span></a>
                        <ul>
                    ...
                    <li>
                        <a href="other_calendar.html" title=""><img src="/PHP_2/Admin/Public/TPLDIST/images/icons/mainnav/other.png" alt="" /><span>Other pages</span></a>
                        <ul>
    ...
    <div id="content">
        <div class="contentTop">
            <span class="pageTitle"><span class=" icon-book" aria-hidden="true"></span>商品详情</span>
            <div class="clear"></div>
        </div>
        <!-- Breadcrumbs line -->
        <div class="breadLine">
            <div class="bc">
                <ul id="breadcrumbs" class="breadcrumbs">
                    ...
                    <li class="current"><a href="##" title="">商品详情</a></li>
                </ul>
            </div>
        </div>
        <!-- Main content -->
                    ...
                    <div class="thumbnail" style="padding:20px;">
                        ...
                        <form class="form-horizontal"> 
                            <div class="form-group">
                                <div class="col-sm-offset-1 col-sm-1">
                                    <label for="imageFile"><img src="/PHP_2/Admin/Public/..<?php echo ($bookDetails["image_Name_S"]); ?>" alt="..." class="img-rounded" style="width:140px;height:140px;"></label>
                                </div>
                            </div>
                           
                            <div class="form-group" >
                                <label class="col-sm-2 " style="text-align:right"><h3>书名</h3></label>
                                <div class="col-sm-9">
                                    <h3><?php echo ($bookDetails["book_title"]); ?></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2" style="text-align:right"><h3>作者</h3></label>
                                <div class="col-sm-9">
                                    
                                    <h3><?php echo ($bookDetails["book_author"]); ?></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 " style="text-align:right"><h3>类别</h3></label>
                                <div class="col-sm-9">
                                    <h3><?php echo ($bookDetails["cate_name"]); ?></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 " style="text-align:right"><h3>价格</h3></label>
                                <div class="col-sm-9">
                                    <h3>￥<?php echo ($bookDetails["book_price"]); ?></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 " style="text-align:right"><h3>添加时间</h3></label>
                                <div class="col-sm-9">
                                    <h3><?php echo (date("Y-m-d H:i:s",$bookDetails["book_pudate"])); ?></h3>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 " style="text-align:right;margin-top:10px;"><h3>商品描述</h3></label>
                                <div class="col-sm-9" style="padding:10px 5px;">
                        ...
                        <!-- <div class="form-group">
                            <div class="col-sm-offset-0 col-sm-9">
                                <label ><img src="/PHP_2/Admin/Public/dist/bookImage/1.jpg" alt="..." class="img-rounded"></label>
                            </div>
                         <div class="clear"></div>

                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 "><h3>书名</h3></label>
                            <div class=" col-sm-9">
                                <?php echo ($bookDetails["book_title"]); ?>
                            </div>
                        </div> -->
                        <div class="caption">
                           
                           
                            <p><a href="<?php echo U('Book/book');?>" class="btn btn-default" role="button">返回</a></p>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
