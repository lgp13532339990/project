    ...
    <div id="content">
        ...
        <div class="breadLine">
            <div class="bc">
                <ul id="breadcrumbs" class="breadcrumbs">
                    ...
                    <li class="current"><a href="##" title="">订单信息</a></li>
                </ul>
            </div>
        </div>
        <!-- Main content -->
        <div class="wrapper" style="padding-top:30px">
            <table class="table table-hover">
                ...
                <?php if(is_array($OrderDataList)): $i = 0; $__LIST__ = $OrderDataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($val["order_id"]); ?></td>
                        <td><?php echo ($val["user_name"]); ?></td>
                        <td><?php echo ($val["order_addtime"]); ?></td>
                        <!-- <td><?php echo ($val["book_desc"]); ?></td> -->
                        <td>
                            <a href='<?php echo U("Order/orderDetails",array("order_id"=>$val["order_id"]));?>' class="btn btn-success btn-xs">查看详情</a>
                            <a href='<?php echo U("Order/orderDelete",array("order_id"=>$val["order_id"]));?>' class="btn btn-danger btn-xs">删除</a>
                        </td>
