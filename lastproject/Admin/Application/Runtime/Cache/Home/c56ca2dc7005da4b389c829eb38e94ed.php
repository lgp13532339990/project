...
<body>
    ...
    <div id="content">
        <div class="contentTop">
            <span class="pageTitle"><span class=" icon-book" aria-hidden="true"></span>商品评论修改</span>
            <div class="clear"></div>
        </div>
        <!-- Breadcrumbs line -->
        <div class="breadLine">
            <div class="bc">
                <ul id="breadcrumbs" class="breadcrumbs">
                    ...
                    <li><a href="<?php echo U('Book/bookComment');?>">商品评论</a></li>
                    <li class="current"><a href="##" title="">商品评论修改</a></li>
                </ul>
            </div>
        </div>
        <!-- Main content -->
            ...
            <div class="row ">
                <div class="col-sm-8 col-md-6">
                    <div class="thumbnail " style="padding:30px">
                        <h1>商品评论修改</h1>
                        <hr>
                        <form class="form-horizontal" action="<?php echo U('Book/bookCommentEditAction');?>" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-0 col-sm-12">
                                    <textarea name="comment_content" id="" cols="30" rows="10"><?php echo ($commentData["comment_content"]); ?></textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                <div class="col-sm-offset-8 col-sm-10">
                                    <a href="<?php echo U('Book/bookComment',array('book_id'=>$commentData['book_id']));?>" type="submit" class="btn btn-default btn-lg">返回</a>
